...
# Automatically generated by the wizard. PLEASE DO NOT EDIT!
empty_CPU_CPPASRC = bertos/cpu/cortex-m/hw/crt_cm3.S bertos/cpu/cortex-m/hw/vectors_cm3.S 
empty_CPU_CPPAFLAGS = -g -gdwarf-2 -mthumb -mno-thumb-interwork
empty_CPU_CPPFLAGS = -O0 -g3 -gdwarf-2 -mthumb -mno-thumb-interwork -fno-strict-aliasing -fwrapv -fverbose-asm -Ibertos/cpu/cortex-m/ -D__ARM_STM32F100RB__
empty_CPU_CSRC = bertos/cpu/cortex-m/hw/init_cm3.c bertos/cpu/cortex-m/drv/irq_cm3.c bertos/cpu/cortex-m/drv/gpio_stm32.c bertos/cpu/cortex-m/drv/clock_stm32.c 
...
empty_CPU_LDFLAGS = -mthumb -mno-thumb-interwork -nostartfiles -Wl,--no-warn-mismatch -T bertos/cpu/cortex-m/scripts/stm32f100rb_rom.ld
